...
%   a set of N 4-outcome tetrahedron measurements and the objective function
...
% upper bound for the critival visibility of rho_AB subjected to N 4-outcome
% tetrahedron measurements
eta = fval;

end

function eta = wnr_qubittetra(x,rho_AB,N)
%wnr_qubittetra Is the function called by fminsearch. It uses parameters x to 
%   define a set of N 4-outcome tetrahedron measurements M_ax. Then it calls SDP 
