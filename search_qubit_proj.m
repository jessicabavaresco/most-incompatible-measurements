...
%search_qubit_proj Calculates a lower bound for the critical visibility
%   eta of a two-qubit quantum state rho_AB subjected to N 2-outcome projective
...
%   a set of N 2-outcome projective measurements and the objective function
...
np = 2*N;           % total number of parameters in fminsearch
...
%wnr_qubitproj Is the function called by fminsearch. It uses parameters x to 
