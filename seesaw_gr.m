...
%   The output of GR_sdp1 will be the input of GR_sdp2, and the output
%   of GR_sdp2 will be the input of GR_sdp1 in the next round of the.
%   iteration. The iteration is halted when the difference between the
%   optimal value of the objective function in GR_sdp1 in two subsequent
